...
|------|---------|-----|----------|--------|------|------|
| Logistic Regression | 0.821 | 0.922 | 0.811 | 0.882 | 0.845 | 0.6362 |
| Decision Tree | 0.766 | 0.757 | 0.761 | 0.843 | 0.800 | 0.5246 |
| KNN | 0.848 | 0.901 | 0.830 | 0.912 | 0.869 | 0.6295 |
| Naive Bayes | 0.853 | 0.910 | 0.871 | 0.863 | 0.867 | 0.7034 |
| Random Forest | 0.842 | 0.923 | 0.835 | 0.892 | 0.863 | 0.6803 |
| XGBoost | 0.842 | 0.895 | 0.848 | 0.873 | 0.860 | 0.6802 |
